...
judge_count %>% 
  ...
  labs(
    ...
    *Case-days is the sum of case lengths for all the cases the judge worked on, many of them concurrently.")  +
  annotate("text", x = 1030, y = 0.55, family = "Tahoma", size=2.5, hjust=0, label = "This Markham judge spent a little under 200,000 case-days\n (not consecutive days, since many cases are concurrent)\n on under 500 cases, while their counterparts in other districts\n spent far fewer case-days on the same number of cases.") +
  annotate("segment", x = 400, xend = 1000, y = 1.35, yend = 0.7,color="black", linetype="dashed") + 
  my_theme +
...
Illinois law describes a number of options for pretrial release, supervision, and incarceration. These include:
