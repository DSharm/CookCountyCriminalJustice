...
libs <- c("tidyverse", "stringr", "readr", "dplyr", "ggplot2", "readstata13","foreign",
          "magrittr","lubridate","here","ggrepel","treemapify")
...
labs(
    ...
    y="Proportion of All Offenses Sentenced",
    x = "",
...
judge_count %>% 
  ...
  labs(
    ...
    y = "Total Number of Days Spent on Cases By Judge \n (Hundreds of Thousands of Days)",
...
bond_court_disp_sum$type_bond <- factor(bond_court_disp_sum$type_bond, levels = c("sum_nolle","sum_nobail","sum_bts","sum_Ibonds",
                                                                                  "sum_emi","sum_Dbonds","sum_Cbonds"),
                                           labels = c("Nolle Pros","No Bail", "Bond to Stand", 
                                                      "I-Bonds","EMI","D Bonds", "C Bonds"), ordered = TRUE)
